...
Create the properties file [/opt/signserver/myconfig/worker-crypto.properties](myconfig/worker-crypto.properties).
...
Create the file [/opt/signserver/myconfig/worker-xmlsigner.properties](myconfig/worker-xmlsigner.properties)
